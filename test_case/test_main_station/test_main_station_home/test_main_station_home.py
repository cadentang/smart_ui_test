...
class TestMainStationHomePage:
    ...
    def test_main_station_home_top_nav_not_login(self, get_driver, home_page):
    ...
    @allure.severity(allure.severity_level.BLOCKER)
    def test_main_statione_home_sku(self, get_driver, home_page):
    ...
    @allure.severity(allure.severity_level.BLOCKER)
    def test_main_station_home_bottom_nav(self, get_driver, home_page):
