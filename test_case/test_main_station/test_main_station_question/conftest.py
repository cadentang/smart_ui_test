...
from data.main_station.main_station_business_data import login_question_data
...
def go_to_question_page(get_driver):
    ...
    course_page = MainStationHomePage(get_driver).go_to_login_page().to_login(login_question_data["login_type"],
                                                                              login_question_data["phone"],
                                                                              login_question_data["password"])
